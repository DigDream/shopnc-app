package com.daxueoo.shopnc.widgets.pulltozoom;
...
public class PullToZoomListViewEx extends PullToZoomBase<ListView> implements AbsListView.OnScrollListener {
    private static final String TAG = com.daxueoo.shopnc.widgets.pulltozoom.PullToZoomListViewEx.class.getSimpleName();
        ...
        public void run() {
            if (mZoomView != null) {
                ...
                if ((!mIsFinished) && (mScale > 1.0D)) {
                    ...
                    f2 = mScale - (mScale - 1.0F) * com.daxueoo.shopnc.widgets.pulltozoom.PullToZoomListViewEx.sInterpolator.getInterpolation(f1);
